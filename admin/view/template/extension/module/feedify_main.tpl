    ...
    <div class="feedify-container">
      ...
      <div class="feedify-form-container">
        <div class="feedify-form inline-forms">
          <h3>New to Feedify? Create your account  <span class="right">Already a Feedify user? Get Started by loging <a href="javascript:void(0);" id="button" >here</a></span></h3>
          <hr/>
          <?php 
            $src_url = $feedify_host . "/thirdparty/signup?" . "next=" . urlencode($next_url) .
