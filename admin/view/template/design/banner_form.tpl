              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-left" style="width: 30%;"><textarea name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]" class="form-control" placeholder="<?php echo $entry_description; ?>" > <?php echo $banner_image['description']; ?></textarea></td>
...
function addImage(language_id) {
	...
	html += '  <td class="text-left" style="width: 30%;"><textarea name="banner_image[' + language_id + '][' + image_row + '][description]" placeholder="<?php echo $entry_description; ?>" class="form-control" > </textarea></td>';	
