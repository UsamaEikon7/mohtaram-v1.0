...
class ControllerProductCategory extends Controller {
	/*
	In this Controller we have added some extra funcitonality in to the open cart controller
	Which is that if no category is selected than we are going to move the product into the Category listing page
	Where user can select the category
	...
	*/
	...
	public function index() {
		...
		if (isset($this->request->get['path'])) {
                    ...
                    foreach ($this->request->get['attributes_filters'] as $attribute_id => $attributes) {
                        if (is_array($attributes)) {
                            foreach ($attributes as $value) {
                                $url .= '&attributes_filters[' . $attribute_id . '][]=' . $value;
                            }
                        }
                    }
                    $attributes_filters = $this->request->get['attributes_filters'];
                }
			...
			// This is where we shows the category listing page
			$data['breadcrumbs'][] = array(
					'text' => "Product Categories",
					'href' => $this->url->link('product/category')
				);
			$this->document->setTitle("Product Categories");
			$this->document->setDescription("Browse through the vast collection of our items");
			$this->document->setKeywords("Product Categories");

			$p_categories 		= 	$this->model_catalog_category->getCategories(0);
			$data['categories']	=	'';
