 ...
 <div class="panel panel-default check-boxstyle cartpanelheading">
  <div class="panel-heading">
  	<h2 class="panel-title"><a href="#collapse-shipping" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"><?php echo $heading_title; ?></a>     </h2>
  </div>              
  <div id="collapse-shipping" class="panel-collapse collapse">
      <div class="panel-body">
          <p><?php echo $text_shipping; ?></p> 
            ...
            <input id="button-quote" class="continue-btn" value="Get Quote" type="button">
