...
<body class="stretched <?php echo $class; ?> <?php if(isset($body_class)){echo $body_class;} ?>">
    ...
    <div class="topheader header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-3 col-sm-5 col-xs-12" id="search">
                    	<?php echo $search; ?>
                     </div><!--col md sm 3-->
                     <div class="col-md-6 col-sm-2 col-xs-4 text-center">
                     <?php if ($logo) { ?>
                    	<a class="navbar-brand logo" href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $name; ?>" title="<?php echo $name; ?>"/></a>
                        <a class="navbar-brand sticky-logo" href="<?php echo $home; ?>"><img src="catalog/view/theme/default/img/sticky-logo.png" alt="<?php echo $name; ?>" title="<?php echo $name; ?>"/></a>
                    <?php }else { ?>
                    	<a class="navbar-brand logo" href="<?php echo $home; ?>"><img src="catalog/view/theme/default/img/logo.png" alt="<?php echo $name; ?>" title="<?php echo $name; ?>"/></a>
                        <a class="navbar-brand sticky-logo" href="<?php echo $home; ?>"><img src="catalog/view/theme/default/img/sticky-logo.png" alt="<?php echo $name; ?>" title="<?php echo $name; ?>"/></a>
                    <?php } ?>
                    </div>
                    <div class="col-md-3 col-sm-5 col-xs-8 social-links">
                    	
                       <a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>" id="cart"><span id="cart-total"><?php echo $cart; ?></span><i class="fa fa-shopping-cart"></i> </a>
                       <!--<a href="<?php echo $wishlist; ?>" id="wishlist-total" title="<?php echo $text_wishlist; ?>">Wishlist <i class="fa fa-heart"></i></a> -->
        			   <a href="<?php echo $checkout; ?>" title="<?php echo $text_checkout; ?>">Checkout <i class="fa fa-share"></i> </a>
                       
                       
                       <a href="<?php echo $account; ?>" class=" dropdown dropdown-toggle" data-toggle="dropdown" > Account <i class="fa fa-user"></i></a>
