...
<?php // banner 2,3 ?>
		...
		foreach ($banner2  as $banner) { ?>
          <div class="collection-content">
               ...
               <div class="collection-bg" style="background: url(<?php echo M_IMAGE.$banner['image']; ?>)"></div><!--about bg-->
...
<a href="<?php echo $banner['link'];  ?>" class="readmore-btn hvr-fade">Take a look</a>
    ...
    <?php if(!empty($banner3)){
		foreach ($banner3  as $banner) { ?>
               ...
               <div class="product-week-bg" style="background: url(<?php echo M_IMAGE.$banner['image']; ?>)">
    ...
    <?php if(!empty($banner4)){
		foreach ($banner4  as $banner) { ?> 
               <div class="frame-life-bg" style="background: url(<?php echo M_IMAGE.$banner['image']; ?>)">
