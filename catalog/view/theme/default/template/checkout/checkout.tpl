    ...
    <section class="main_top">
      ...
      <div class="panel-group" id="accordion">
        <div class="panel panel-default check-boxstyle cartpanelheading">
            ...
            <h2 class="panel-title"><?php echo $text_checkout_option; ?></h2>
          </div>
        ...
        <div class="panel panel-default check-boxstyle cartpanelheading">
          <div class="panel-heading">
            <h2 class="panel-title"><?php echo $text_checkout_account; ?></h2>
          </div>
        ...
        <div class="panel panel-default check-boxstyle cartpanelheading">
          <div class="panel-heading">
            <h2 class="panel-title"><?php echo $text_checkout_payment_address; ?></h2>
          </div>
          <div class="panel-collapse collapse" id="collapse-payment-address">
            <div class="panel-body"></div>
          </div>
        ...
        <div class="panel panel-default check-boxstyle cartpanelheading">
          <div class="panel-heading">
            <h2 class="panel-title"><?php echo $text_checkout_shipping_address; ?></h2>
          </div>
        ...
        <div class="panel panel-default check-boxstyle cartpanelheading">
          <div class="panel-heading">
            <h2 class="panel-title"><?php echo $text_checkout_shipping_method; ?></h2>
          </div>
        ...
        <div class="panel panel-default check-boxstyle cartpanelheading">
          <div class="panel-heading">
            <h2 class="panel-title"><?php echo $text_checkout_payment_method; ?></h2>
          </div>
