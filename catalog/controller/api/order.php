...
class ControllerApiOrder extends Controller {
	...
	public function history() {
		...
		//Order status 17 is for dispatch so we have to use TCS controller for this
		//print_r($this->request->post); exit;
		if($this->request->post['order_status_id'] == 17){
			// this mean the order is going to be sent for shipment than we have to load the controller TCS
